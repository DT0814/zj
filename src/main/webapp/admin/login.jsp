                    ...
                    <div class="box">
                        <div class="content">
                            ...
                            <div class="form loginBox">
                                <form id="LoginForm">
                                    <input class="form-control" type="text" placeholder="account" name="tnum">
    ...
    var vu = new Vue({
        ...
        methods: {
            ...
            login: function () {
                axios.post('${APP_PATH}/teacher/login.action', $("#LoginForm").serialize())
                        .then(function (response) {
                            ...
                            if (result.code == 200) {
                                alert("登陆成功");
                                vu.$options.methods.loginSuccess(result.data);
                            } else {
                                alert(result.msg);
                            }
                        });
            ...
            loginSuccess: function (data) {
                $.cookie('teacher_tname', data.tname, {expires: 7, path: '/'});
                $.cookie('teacher_tnum', data.tnum, {expires: 7, path: '/'});
                $.cookie('teacher_isLogin', true, {expires: 7, path: '/'});
